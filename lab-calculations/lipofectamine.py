...
def calculate_lipofection_volumes(well_format, num_wells, dna_concentration_ug_per_ul=1.0):
    ...
    Parameters:
        well_format (str): '96-well', '24-well', or '6-well'
    ...
    if well_format not in protocol_table:
        raise ValueError("Invalid well format. Choose from: '96-well', '24-well', or '6-well'")
    ...
    total = {
        # Split DNA + P3000 mix into two tubes
...
if __name__ == "__main__":
    ...
    well_format = '12-well'
    num_wells = 12
    dna_concentration_ug_per_ul = 0.8
    volumes = calculate_lipofection_volumes(well_format, num_wells, dna_concentration_ug_per_ul)
    os.system('clear')
    print("Lipofection Reagent Volumes for 12 wells (12-well plate):\n")
